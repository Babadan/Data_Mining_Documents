...
def naiveBayes():
    ...
    mt.printAvergedRocCurve(tprs_macro, base_fprs_macro, auc_macro, "Macro", "../RocCurve/" + 'NB_roc_macro.png')
    mt.printAvergedRocCurve(tprs_micro, base_fprs_micro, auc_micro, "Micro", "../RocCurve/" + 'NB_roc_micro.png')
